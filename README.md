...
# - Done JS Chapter  (Scroll down for the next project, currently React++) 
	...
	--------------------------- Browser: Document, Events, Interfaces -------------------------- 
             ...
             - done  Let’s learn the fundamentals of script building.
...
# Technical Skills Training ( Not started ) 
				...
				Section 18: +The Final Video
				Section 19: +Extras: For Windows Users
				Section 20: +Extras
...
# Realtime App + Hooks and GraphQL


				Section 1: +Getting Started
				Section 2: +Building our GraphQL Server
				Section 3: +Social Login with Google OAuth 2.0
				Section 4: +Managing App State with useReducer / useContext Hooks
				...
				Section 11: +Making Custom useClient Hook
				Section 12: +Getting / Displaying Created Pins
				Section 13: +Popups and Highlighting New Pins
				Section 14: +Deleting User Pins
				Section 15: Section 6: +Displaying Pin Content
				Section 16: +Add Comment Functionality
...
# React Native + Hooks Project ( Not started )
				...
				Section 13: +Building a Custom Express API
